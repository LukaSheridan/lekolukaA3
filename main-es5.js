...
var LekolukaComponent = /** @class */ (function () {
    function LekolukaComponent() {
        this.mybooks = _assets_data_myBooks__WEBPACK_IMPORTED_MODULE_2__["MYBOOKS"];
    }
    LekolukaComponent.prototype.ngOnInit = function () {
        this.onButtonClick(0);
    };
    LekolukaComponent.prototype.onButtonClick = function (index) {
        this.pickedBook = {
